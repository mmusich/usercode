#include "ZbbAnalysis/Tools/plugins/TotalKinematicsFilter.h"
...
void TotalKinematicsFilter::endJob() {
  
  double eff = double(wasAccept/wasRun);
  double efferr = std::sqrt((eff*(1-eff))/wasRun);

  std::cout<<"***********************************"<<std::endl;
  std::cout<<"* TotalKinematicsFilter::endJob() "<<std::endl;
  std::cout<<"***********************************"<<std::endl;
  std::cout<<"* Was run on       : "<<wasRun<<" events"<<std::endl;
  std::cout<<"* Was accepted on  : "<<wasAccept<<" events"<<std::endl;
  std::cout<<"* Filter efficiency: "<<eff*100<<"+/-"<<efferr*100<<"%"<<std::endl;
  std::cout<<"***********************************"<<std::endl;
