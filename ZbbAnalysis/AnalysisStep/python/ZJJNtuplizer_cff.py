...
#     ),
    ...
    cms.PSet(
    tag = cms.untracked.string("TriggerMatchDau1HLTMu3"),
    quantity = cms.untracked.string("? !daughter(0).masterClone.triggerObjectMatchesByPath('HLT_Mu3').empty?1:0")
    ),
    
    cms.PSet(
    tag = cms.untracked.string("TriggerMatchDau2HLTMu3"),
    quantity = cms.untracked.string("? !daughter(1).masterClone.triggerObjectMatchesByPath('HLT_Mu3').empty?1:0")
    ),

    cms.PSet(
    tag = cms.untracked.string("TriggerMatchDau1HLTMu5"),
    quantity = cms.untracked.string("? !daughter(0).masterClone.triggerObjectMatchesByPath('HLT_Mu5').empty?1:0")
    ),
    
    cms.PSet(
    tag = cms.untracked.string("TriggerMatchDau2HLTMu5"),
    quantity = cms.untracked.string("? !daughter(1).masterClone.triggerObjectMatchesByPath('HLT_Mu5').empty?1:0")
    ),

    cms.PSet(
    tag = cms.untracked.string("TriggerMatchDau1HLTMu7"),
    quantity = cms.untracked.string("? !daughter(0).masterClone.triggerObjectMatchesByPath('HLT_Mu7').empty?1:0")
    ),
    
    cms.PSet(
    tag = cms.untracked.string("TriggerMatchDau2HLTMu7"),
    quantity = cms.untracked.string("? !daughter(1).masterClone.triggerObjectMatchesByPath('HLT_Mu7').empty?1:0")
    ),
...
zll = (
    ...
    cms.PSet(
    tag = cms.untracked.string("LeptDau1isMuon"),
    quantity = cms.untracked.string("?daughter(0).isMuon()?1:0")
    ),
    cms.PSet(
    tag = cms.untracked.string("LeptDau2isMuon"),
    quantity = cms.untracked.string("?daughter(1).isMuon()?1:0")
    ),

    cms.PSet(
    tag = cms.untracked.string("LeptDau1isElectron"),
    quantity = cms.untracked.string("?daughter(0).isElectron()?1:0")
    ),
    cms.PSet(
    tag = cms.untracked.string("LeptDau2isElectron"),
    quantity = cms.untracked.string("?daughter(1).isElectron()?1:0")
    ),
...
ZLLNtuplizer = copy.deepcopy(zed)
ZLLNtuplizer.src = cms.InputTag("zllCand")
ZLLNtuplizer.prefix = cms.untracked.string("Zll")
ZLLNtuplizer.variables += zll

JetNtuplizer = copy.deepcopy(zed)
JetNtuplizer.src = cms.InputTag("cleanPatJetsPF")
